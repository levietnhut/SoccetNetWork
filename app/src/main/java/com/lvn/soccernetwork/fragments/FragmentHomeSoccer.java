...
public class FragmentHomeSoccer extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.newss).setText("News"));
...
//        tabLayout.addTab(tabLayout.newTab().setCustomView(tvMaps));
        ...
        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.field).setText("Fields"));
        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.maps).setText("Maps"));
